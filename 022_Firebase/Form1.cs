...
namespace _021_Firebase
{
    ...
    {
        DataTable dt = new DataTable();  //dt엔 4개의 form을 추가해야함
        ...
        private async void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            SetResponse response = await client.SetAsync("VP02_Phonebook/" + data.Id, data);  //SetAsync 값을 저장한다.
        ...
        // Firebase에서 데이타를 읽고 dataGridView1에 표시
